...
with open ('171.jpg', 'rb') as file:
    img = file.read()
    img = str(base64.b64encode(img))[1:]

# Create the image command, this includes the sender, receiver, content type and MIME-Version. MIME allows us to attach an image to the message using a multipart message.
imgCommand ='''From: "Monanshi Shah" <shahmonanshi@gmail.com>
To: "Ryan Hellowell" <mshah88@uwo.ca>
Subject: ECE4436 - Lab 3: Monanshi Shah, Ryan Hellowell
MIME-Version: 1.0
Content-Type: multipart/mixed;boundary="sendImage"
--sendImage
Content-Type: application/octet-stream;name="171.jpg"
Content-Transfer-Encoding: base64
Content-Disposition:attachment;filename="171.jpg"
